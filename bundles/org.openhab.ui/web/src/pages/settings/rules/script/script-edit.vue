<template>
  <f7-page @page:afterin="onPageAfterIn" @page:beforeout="onPageBeforeOut">
    ...
    <template v-if="ready">
      ...
      <f7-link v-if="hasOpaqueModule" icon-f7="info_circle" class="float-right margin" style="opacity:0.5; z-index: 4000; user-select: none" icon-size="50" color="blue" @click="detailsOpened = !detailsOpened" :tooltip="'This code is just a representation of the code that is executed, the actual code might do something different'" />
      <f7-icon v-else-if="!createMode && (!isBlockly && !editable) || (blocklyCodePreview && isBlockly)" f7="lock" class="float-right margin" style="opacity:0.5; z-index: 4000; user-select: none;" size="50" color="gray"
...
export default {
  ...
  computed: {
    ...
    hasOpaqueModule () {
      return this.currentModule && RuleStatus.isOpaqueModule(this.currentModule)
    }
  },
  watch: {
